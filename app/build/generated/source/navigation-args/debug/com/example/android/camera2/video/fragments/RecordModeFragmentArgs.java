...
public class RecordModeFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private RecordModeFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private RecordModeFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static RecordModeFragmentArgs fromBundle(@NonNull Bundle bundle) {
    RecordModeFragmentArgs __result = new RecordModeFragmentArgs();
    bundle.setClassLoader(RecordModeFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    RecordModeFragmentArgs that = (RecordModeFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(RecordModeFragmentArgs original) {
    ...
    @NonNull
    public RecordModeFragmentArgs build() {
      RecordModeFragmentArgs result = new RecordModeFragmentArgs(arguments);
      return result;
    }
