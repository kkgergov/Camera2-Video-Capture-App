...
abstract class Pipeline(width: Int, height: Int, fps: Int,
    ...
    open public fun createPreviewRequest(session: CameraCaptureSession): CaptureRequest? {
        return null
    }

    public abstract fun createRecordRequest(session: CameraCaptureSession): CaptureRequest
